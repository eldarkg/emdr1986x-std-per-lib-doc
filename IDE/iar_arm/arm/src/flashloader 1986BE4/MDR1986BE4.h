...
#define RST_CLK_UART_CLOCK_UART3_BRG_Pos                   23
...
#define RST_CLK_UART_CLOCK_UART3_BRG                       ((uint32_t)0x00800000)
...
typedef struct {
	...
	__IO uint32_t	DIGGAN;                 /*!< */
	__IO uint32_t	DMAEN;                  /*!< */
	__IO uint32_t	CTRL2;                  /*!< */
	__IO uint32_t	INTEN;                  /*!< */
	__IO uint32_t	STAT;                   /*!< */
	__IO uint32_t	FDAT[8];                /*!< */
}MDR_ADCIU_TypeDef;
...
/** @defgroup Periph_ADCIU_DIGGAN ADCIU DIGGAN
  * @{
  */

/*-- ADCIU_DIGGAN:ADCIU DIGGAN Register -----*/
...
/* Bit field masks: */
#define ADCIU_INTEN_NS1                                    ((uint32_t)0x00000001)
...
/** @defgroup Periph_ADCIU_F_AT ADCIU F_AT
  * @{
  */

/*-- ADCIU_F_AT:ADCIU F_AT Register -----*/

/* Bit field positions: */
#define ADCIU_F_AT_SMPLE_Pos                               0

/* Bit field masks: */
#define ADCIU_F_AT_SMPLE_Msk                               ((uint32_t)0x00FFFFFF)

/** @} */ /* End of group ADCIU_F_AT */
...
/** @defgroup Periph_TIMER_CCR_ TIMER CCR_
  * @{
  */

/*-- TIMER_CCR_:TIMER CCR_ Register -----*/

/* Bit field positions: */
#define TIMER_CCR__CCR_Pos                                 0

/* Bit field masks: */
#define TIMER_CCR__CCR_Msk                                 ((uint32_t)0x0000FFFF)

/** @} */ /* End of group TIMER_CCR_ */
...
/* Bit field masks: */
#define CRC_POL_CRC_POL_Msk                                ((uint32_t)0x0000FFFF)
